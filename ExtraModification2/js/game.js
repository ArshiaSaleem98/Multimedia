...
var game = {
    ...
    handlePanning: function () {
        ...
        if (game.mode == "level-success" ) /*only if user has completed the level successfully */{
            if (game.panTo(0)) {
                game.ended = true;
                gamelevels.push(game.currentLevel['number']+1);/*on gamelevel array we will add the currentlevel that we have finished +1 ,it will help us unblock the next level(newly added)*/
                game.showEndingScreen();
            }
        }
    },
    ...
    data: [
        ...
        {//Second level
            ...
            entities: [
                ...
                { type: "villain", name: "villain1", x: 570, y: 405, calories: 420 },
                { type: "villain", name: "villain2", x: 570, y: 280, calories: 420 },
                { type: "villain", name: "villain1", x: 730, y: 280, calories: 420 },
                { type: "villain", name: "villain2", x: 730, y: 405, calories: 420 },
                { type: "villain", name: "villain1", x: 570, y: 155, calories: 420 },
                { type: "villain", name: "villain2", x: 730, y: 155, calories: 420 },

            
                { type: "hero", name: "hero1", x: 30, y: 415 },
